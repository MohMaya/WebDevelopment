...
<body class="container-fluid">
      ...
      <div class="jumbotron">
          ...
          $pin= $_POST['pin'];
        	...
        	$sql = "INSERT INTO `Dealer` (`Did`, `Name`, `PhNo`, `PhNo2`, `Eid`, `Brand`, `City`, `State`, `Status`,`PIN`) VALUES  ( NULL ,'$nm','$pn','$pn2','$ei','$bd','$ci','$st','0',$pin)";
        	...
        	else
        	{
        		echo "<h1>Thank You!!</h1>
                        <p>You Have Been Registered<br>We'll Contact you as soon as we get an enquiry</p>";
        	}
