...
<body class="container-fluid">
      <nav class="navbar navbar-inverse nav-bar-fixed-top">
            <div class="container-fluid">
                 ...
                 <ul class="nav navbar-nav ">
                      ...
                      <li><a href="vif.php">Information</a></li>
      ...
      <div class="jumbotron">
                ...
                //name,brand,price,rating,mil,eng,transmission,abs,airbags,type,addr,rev
        	$brand = $_POST['brand'];
                $name = $_POST['name'];
                $price = $_POST['price'];
                $rating = $_POST['rating'];
                ...
                //echo "'$brand','$name','$price','$rating','$mileage','$engine','$transmission','$abs','$airbags','$type','$address','$review'";

        	$sql = "INSERT INTO `Car`(`CarId`, `Name`, `Price`, `Ratings`, `Mileage`, `Engine`, `Transmission`, `ABS`, `AirBags`, `Review`, `Brand`, `Image`, `Type`) VALUES (NULL,'$name','$price','$rating','$mileage','$engine','$transmission','$abs','$airbags','$review','$brand','$address','$type')";

        	if (!mysqli_query($conn,$sql)) {
                        echo "<h1>OOPS !!!</h1>
                        <p>There seems to be an error<br>We'll Contact you as soon as we get back online</p>";
                        die("Error ".mysqli_error($link));
        	}
        	else
        	{
        		echo "<h1>Thank You!!</h1>
                        <p>The Car has been Added</p><br>
                        <p><a href='addnews.php'>Add Another Car</a></p>";
        	}
