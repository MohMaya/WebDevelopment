...
<body class="container-fluid">
      ...
      <div class="jumbotron">
        	...
        	$sql = "INSERT INTO `news` (`news_id`, `heading`, `Subhead`, `article`, `date`) VALUES (NULL, '$ti', '$sh', '$ar', '2017-03-03')";
        	...
        	else
        	{
        		echo "<h1>Thank You!!</h1>
                        <p>The News has been succesfully added</p>";
        	}
                                    ...
                                    if (mysqli_connect_errno())
                                  {
                                    ...
                                    while($rows = mysqli_fetch_assoc($result))
                                    {
                                              ...
                                              echo "    <div class='col-md-9 col-sm-9 col-lg-12' text-overflow: ellipsis; white-space: nowrap; overflow: hidden;>
                                                                <hr>
                                                                <a href='newssp.php?id=$id'><h5>$head</h5></a>
                                                                <p>$subhead</p>
